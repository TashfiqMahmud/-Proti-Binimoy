...
const ForgotPasswordPage = () => {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      >
        <div className="absolute inset-0 bg-[linear-gradient(115deg,rgba(2,6,23,0.9)_0%,rgba(2,6,23,0.8)_44%,rgba(15,118,110,0.2)_100%)]" />
        <div className="relative z-10 mx-auto flex min-h-screen max-w-4xl items-center justify-center px-6 py-12">
          <div className="w-full max-w-2xl rounded-[1.8rem] border border-white/15 bg-white/10 p-3 shadow-[0_30px_90px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
            <div className="rounded-[1.5rem] bg-white p-8 text-slate-900 md:p-10">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link
                  to="/register"
                  className="inline-flex rounded-full border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-emerald-500 hover:text-emerald-600"
                >
                  Create New Account
                </Link>
              </div>
